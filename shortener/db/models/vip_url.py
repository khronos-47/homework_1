...
class VipStorage(DeclarativeBase):
    __tablename__ = "vip_storage"
    ...
    url_expires = Column(INTEGER, nullable=False, default=timedelta(days=2), doc="time to live vip url (max 2 days)")
